...
<body>
		...
		<div class="container">
			<div class="agile_ab_w3ls_info">
				<div class="col-md-6 ab_pic_w3ls">
					<img src="resources/images/ab_pic.jpg" alt=" "
						class="img-responsive" />
				</div>
				<div class="col-md-6 ab_pic_w3ls_text_info">
					<h5>
						About Our S<span>hopoholics</span>
					</h5>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing
						elPellentesque vehicula augue eget nisl ullamcorper, molestie
						blandit ipsum auctor. Mauris volutpat augue dolor..</p>
			...
			<div class="banner_bottom_agile_info_inner_w3ls">
				<div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
					<figure class="effect-roxy">
						<img src="resources/images/bottom1.jpg" alt=" "
							class="img-responsive" />
						<figcaption>
							<h3>
				...
				<div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
					<figure class="effect-roxy">
						<img src="resources/images/bottom2.jpg" alt=" "
							class="img-responsive" />
						<figcaption>
							<h3>
								<span>F</span>all Ahead
				...
				<div class="col-md-3 team-grids">
					<div class="thumbnail team-w3agile">
						...
						<div class="social-icons team-icons right-w3l fotw33">
							...
							<ul
								class="social-nav model-3d-0 footer-social w3_agile_social two">
		...
		<div class="container">
			...
			<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
				<a href="women.html">
					<div class="bb-left-agileits-w3layouts-inner grid">
						<figure class="effect-roxy">
							<img src="resources/images/bb1.jpg" alt=" "
								class="img-responsive" />
							<figcaption>
								<h3>
									<span>S</span>ale
			...
			<div class="col-md-7 bb-grids bb-middle-agileits-w3layouts">
				<div class="bb-middle-agileits-w3layouts grid">
					<figure class="effect-roxy">
						<img src="resources/images/bottom3.jpg" alt=" "
							class="img-responsive" />
						<figcaption>
							<h3>
								<span>S</span>ale
				...
				<div class="bb-middle-agileits-w3layouts forth grid">
					<figure class="effect-roxy">
						<img src="resources/images/bottom4.jpg" alt=" "
							class="img-responsive">
						<figcaption>
							<h3>
								<span>S</span>ale
	...
	<div class="agile_last_double_sectionw3ls">
		<div class="col-md-6 multi-gd-img multi-gd-text ">
			<a href="womens.html"><img src="resources/images/bot_1.jpg"
				alt=" ">
				<h4>
		...
		<div class="col-md-6 multi-gd-img multi-gd-text ">
			<a href="womens.html"><img src="resources/images/bot_2.jpg"
				alt=" ">
				<h4>
					Flat <span>50%</span> offer
				</h4></a>
